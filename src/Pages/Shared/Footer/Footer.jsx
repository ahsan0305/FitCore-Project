...
const Footer = () => {
    return (
        <div className="max-w-7xl mx-auto">
            <footer className="footer p-10 bg-[#1D2229] text-base-content">
                ...
                <nav>
                    ...
                    <a className="link link-hover">+1  269-537-1744</a>
                    <a className="link link-hover">Info@fitcore.com</a>
                    <a className="link link-hover">3033 Goff Avenue, Michigan, <br />
                        Grand Rapids, USA</a>
                </nav>
            </footer>
            <footer className="footer px-10 py-4 border-t border-[#D8D4D433] bg-[#1D2229] text-base-content border-base-300">
