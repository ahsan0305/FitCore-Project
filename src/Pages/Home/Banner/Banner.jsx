...
const Banner = () => {
    return (
        <div className="">
            <div className="banner hero h-[600px] lg:min-h-screen " style={{ backgroundImage: 'url(../../../../public/Images/banner_img.jpg)'}}>
                <div className="w-full lg:max-w-7xl px-[20px] lg:px-[0px] mx-auto">
                    <div className="w-full lg:w-[680px]">
                        ...
                        <p className="mb-[80px] text-[#E8E8E8] text-[16px] lg:text-[20px] font-medium lg:font-medium text-center lg:text-left">Engaging in regular exercise not only amplifies well-being and fortifies the body but also diminishes the likelihood of injuries thereby optimizing.</p>
