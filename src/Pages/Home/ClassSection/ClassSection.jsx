                        ...
                        <div className="card before--none rounded-none w-full lg:w-[98%]  image-full">
                            ...
                            <div className="card-body flex items-center justify-center">
                                <div className="w-[330px] text-center">
                                    <h2 className="text-[32px] lg:text-4xl font-bold text-[#fff] font-poppins mb-[28px]">Strength Training</h2>
                                    <p className="text-[#F3F3F3] font-normal text-[16px] lg:text-[20px] ">Classes focusing on building muscle strength and endurance through weightlifting and resistance exercises.</p>
                                    <div className="card-actions justify-center ">
                                        <button className=" mt-10 text-white font-medium text-[14px] lg:text-[20px] rounded bg-gradient-to-r from-green-500 to-[#A1F65E] font-montserrat  text-[#E8E8E8] font-semibold rounded py-[10px] px-[14px] lg:py-[18px] lg:px-[30px] cursor-pointer relative hover:bg-gradient-to-l from-green-500 to-[#A1F65E] hover:text-[#191919] ease-in duration-200 translate-x-1 hover:translate-x-2 hover:translate-y-2 ">Join Now</button>
                                    </div>
                                </div>
                            </div>
                        </div>
